...
import lt.eif.viko.mjakovcenko.banksoap.banksoap.model.*;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Component;

/**
 * This class is responsible for managing client data interactions via the {@link ClientJpaRepository}.
 */
//@Component
public class ClientRepository {
    ...
    /**
     * Automatically injects the {@link ClientJpaRepository} dependency and initializes
     * the client data by calling the {@link #loadClient()} method.
     *
     * @param clientJpaRepository the repository used for accessing client data
     */
  //@Autowired
    public void DataLoader(ClientJpaRepository clientJpaRepository) {
    ...
    public void loadClient() {
       ...
       clientJpaRepository.save(client1);
    }
}
